...
public class CommandConst {
    ...
    public static final String CONFIG_FREQUENCY = "frequency";  //周期、デフォルト:200
    public static final String CONFIG_AMOUNT = "amount";  //一回に発生する量、デフォルト:5
    public static final String CONFIG_SPEED = "speed";  //落下速度、デフォルト:10
    public static final String CONFIG_PLAYER = "player";  //中心のプレイヤー、デフォルト:playerName
}
